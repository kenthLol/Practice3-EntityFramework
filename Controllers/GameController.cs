...
namespace thirdPractice.Controllers
{
    public class GameController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,GameName,Description,Platform,Price,Image")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,GameName,Description,Platform,Price,Image")] Game game)
        {
            if (id != game.Id)
            {
                return NotFound();
